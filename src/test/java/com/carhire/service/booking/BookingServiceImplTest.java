...
class BookingServiceImplTest {
    ...
    @Test
    void confirmBooking_ValidBooking_ChangesStatusToConfirmed() {
    ...
    @Test
    void confirmBooking_InvalidBooking_ThrowsException() {
        ...
        assertThrows(IllegalStateException.class, () -> {
            bookingService.confirmBooking(invalidBooking);
        });
    }
}